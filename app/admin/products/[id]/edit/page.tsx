  ...
  if (notFound) {
    return (
      <div className="text-center py-20">
        <p className="text-muted-foreground/50 font-mono text-sm">Product not found</p>
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold">{t('admin.products.edit')}</h1>
          ...
          {(['fa', 'en', 'ar'] as LangTab[]).map(l => (
            <div key={l} className={`${langTab === l ? 'block' : 'hidden'}`}>
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-border/40 bg-background/50 text-sm outline-none focus:border-primary/50 transition-colors min-h-[100px] resize-y"
                dir={l === 'fa' || l === 'ar' ? 'rtl' : 'ltr'}
              />
            </div>
          ))}
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl border border-border/40 bg-background/50 text-sm outline-none focus:border-primary/50 transition-colors"
