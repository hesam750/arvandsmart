...
export function PricingSection() {
  ...
  const plans = [
    {
      name: { en: 'Basic', fa: 'پایه', ar: 'أساسي' },
      desc: { en: 'For small facilities and single-site monitoring. All core features included.', fa: 'برای تأسیسات کوچک و نظارت تک‌مکانی. تمام ویژگی‌های اصلی.', ar: 'للمنشآت الصغيرة والمراقبة أحادية الموقع. جميع الميزات الأساسية مشمولة.' },
      price: { monthly: 79, annual: 199 },
      features: { en: ['Up to 5 chillers', 'Real-time monitoring', 'Health Score system', 'Email alerts', '7-day data history', 'Basic analytics'], fa: ['تا ۵ چیلر', 'پایش لحظه‌ای', 'سیستم امتیاز سلامت', 'هشدار ایمیلی', 'تاریخچه ۷ روزه', 'تحلیل پایه'], ar: ['حتى ٥ مبردات', 'مراقبة لحظية', 'نظام درجة الصحة', 'تنبيهات البريد الإلكتروني', 'سجل ٧ أيام', 'تحليلات أساسية'] },
      cta: { en: 'Get Started', fa: 'شروع کنید', ar: 'ابدأ الآن' },
      popular: false,
    },
    {
      name: { en: 'Professional', fa: 'حرفه‌ای', ar: 'احترافي' },
      desc: { en: 'For growing operations with multiple sites. Advanced analytics and control.', fa: 'برای عملیات رو به رشد با چندین مکان. تحلیل و کنترل پیشرفته.', ar: 'للعمليات المتنامية مع مواقع متعددة. تحليلات وتحكم متقدمان.' },
      price: { monthly: 199, annual: 499 },
      features: { en: ['Up to 25 chillers', 'Health Score & anomaly detection', 'Predictive maintenance engine', 'Remote setpoint control', '30-day data history', 'API access', 'Priority support'], fa: ['تا ۲۵ چیلر', 'امتیاز سلامت و تشخیص ناهنجاری', 'موتور نگهداری پیش‌بینانه', 'کنترل از راه دور Setpoint', 'تاریخچه ۳۰ روزه', 'دسترسی API', 'پشتیبانی اولویت‌دار'], ar: ['حتى ٢٥ مبرداً', 'درجة الصحة وكشف الشذوذ', 'محرك الصيانة التنبؤية', 'التحكم عن بعد بنقطة الضبط', 'سجل ٣٠ يوماً', 'الوصول إلى API', 'دعم ذو أولوية'] },
      cta: { en: 'Start Free Trial', fa: 'شروع آزمایشی رایگان', ar: 'ابدأ النسخة التجريبية' },
      popular: true,
    },
    {
      name: { en: 'Enterprise', fa: 'سازمانی', ar: 'مؤسسات' },
      desc: { en: 'Custom solutions for large-scale deployments. Unlimited everything.', fa: 'راه‌حل‌های سفارشی برای استقرار در مقیاس بزرگ. نامحدود کامل.', ar: 'حلول مخصصة للنشر على نطاق واسع. كل شيء غير محدود.' },
      price: { monthly: null, annual: null },
      features: { en: ['Unlimited chillers', 'All analytics & control features', 'Dedicated account manager', 'Unlimited data history', 'White-label customization', 'Custom integrations', '24/7 phone support'], fa: ['چیلر نامحدود', 'تمام ویژگی‌های تحلیل و کنترل', 'مدیر حساب اختصاصی', 'تاریخچه نامحدود', 'شخصی‌سازی برند سفید', 'یکپارچه‌سازی سفارشی', 'پشتیبانی تلفنی ۲۴/۷'], ar: ['مبردات غير محدودة', 'جميع ميزات التحليل والتحكم', 'مدير حساب مخصص', 'سجل غير محدود', 'تخصيص العلامة البيضاء', 'تكاملات مخصصة', 'دعم هاتفي ٢٤/٧'] },
